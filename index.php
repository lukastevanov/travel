...
if($name == "" || $activities == "" || $destination == ""){
	...
	$sql = "INSERT INTO booking(name,activities,destination,date)VALUES ('$name','$activities','$destination',now())";
								  ...
								  <!-- Nav tabs -->
								   <ul class="nav nav-tabs" role="tablist">
								      <li role="presentation" class="active">
								      	<a href="#flights" aria-controls="flights" role="tab" data-toggle="tab">Book destination</a>
								      </li>
...
<form method="post" action="index.php">
								   <!-- Tab panes -->
									...
									<div class="col-xxs-12 col-xs-6 mt">
												<div class="input-field">
													<label for="from">Activities:</label>
											...
											<div class="col-xs-12">
												<input type="submit" name="submit" class="btn btn-primary btn-block" value="Destination">
											</div>
										</div>
									 </div>
